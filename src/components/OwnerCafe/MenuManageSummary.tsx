...
const MenuManageSummary = ({ menuCount }: MenuManageSummaryProps) => {
  return (
    <section className="w-full bg-white rounded-2xl border border-gray-100 px-6 py-4 flex items-center justify-between">
      ...
      <button className="flex items-center gap-2 px-4 py-2 rounded-lg bg-[#E17100] text-white text-xs font-semibold hover:bg-[#cf6400] transition-colors">
